...
//Local Wifi config
const char SSID[]     = "ATTaBunKwa";
const char PASSWORD[] = "stfekbpi?wmh";

//The WeatherAPI Requires either a defined text name city/state, a zip or a country/city
// Specify your favorite location one of these ways.
//#define WU_LOCATION "STLOUIS/MISSOURI"

// US ZIP code
//#define WU_LOCATION ""
#define WU_LOCATION "63102"

// Country and city
//#define WU_LOCATION "USA/STLOUIS"
